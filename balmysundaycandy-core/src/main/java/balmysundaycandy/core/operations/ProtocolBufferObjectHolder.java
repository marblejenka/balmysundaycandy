...
public class ProtocolBufferObjectHolder {
	...
	static {
		...
		// XXX action response cause no class def found error
		// pb.put(new ProtocolBufferKey(datastore_v3.packageName,
		// datastore_v3.methodName.AddAction), new ProtocolBufferValue(new
		// ActionRequest(), new ActionResponse()));
